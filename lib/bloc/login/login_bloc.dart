...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  Stream<LoginState> mapEventToState(
   ...
   else if(event is LoginWithCredentialsIsPressed){
     yield* _mapLoginWithCredentialsIsPressedToState(
       email: event.email,
  ...
  Stream<LoginState> _mapLoginWithCredentialsIsPressedToState( {String email,
